...
{
 "use strict";
 var Global,WebApp,Client,WebSharper,UI,Var$1,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 Global=self;
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("WebApp:WebApp.Server.DoSomething:-1717008921",[a.$0]):(b=null,Concurrency.Delay(function()
   {
